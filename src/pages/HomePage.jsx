...
const HomePage = () => {
  ...
  const renderPopularMovieList = () => {
    return moviePopular.slice(0, 5).map((movie) => (
      <PopularMovies key={movie.id} dataPopular={movie} />
    ));
  };
      ...
      <div className="parents">
        <div className="header-section absolute flex justify-between z-50 w-full mt-[.5rem]">
          ...
          <div className="head-btn flex justify-center items-center mx-6">
            <button
              onClick={infoUser}
              className="flex justify-center items-center text-red-500 hover:text-white"
            >
              <CgProfile className="w-[5rem] h-[2.5rem]" />
            </button>
            ...
            <button
              ...
              className="bg-red-500 text-white font-semibold text-[1rem] rounded-full w-[6rem] h-[2.5rem] hover:bg-red-600"
            >
              Logout
            </button>
          </div>
            ...
            return (
              <SwiperSlide key={movie.id}>
                ...
                >
                  ...
                  <div className="desc-section flex flex-col gap-4 w-[60%] text-white mx-4">
